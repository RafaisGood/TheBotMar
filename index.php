...
$botToken =  "5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90";
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
file_get_contents("https://api.telegram.org/bot5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
$premium_id = (array("1792903396","1317173146","1924666696"));
$premiumgp = (array("-1001320804136","-1001552296979","-1001300027599","-1001298504199","-1001434792768","-1001763335199"));
...
// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90/getChatMember?chat_id=@roldexversechats&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot5324581053:AAFIxxyObOF4MdnLE8QQ9kr6TtYDi3E7R90/".$method;
    $ch = curl_init();
